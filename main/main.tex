...
% ============================
% Main color pair (active)
\definecolor{corTitulo}{HTML}{3A0CA3}
\definecolor{corListas}{HTML}{2ECC71}
...
% \definecolor{corTitulo}{HTML}{1D3557}
% \definecolor{corListas}{HTML}{F72585}
...
\newcommand{\CoverPage}{%
  ...
  \begin{center}
    \vspace*{4mm}
    {\fontsize{28}{30}\selectfont\bfseries\color{corTitulo} Batalhas de\\[2mm]Sopa de Letras\par}
    \vspace{4mm}
    {\normalsize Livro de Jogos\par}
    \vspace{7mm}
    \includegraphics[width=.62\linewidth]{capa.png}
    \vfill
    {\small Feito para competicao divertida e treino mental}
  \end{center}
  \newpage
}
...
\newcommand{\BookFolder}{book_pages}
\newcommand{\TotalPages}{30}
